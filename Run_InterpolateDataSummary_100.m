...
%% code
function ReturnStatus = Run_InterpolateDataSummary(SITEDATA_NAME,INPUTDATE,EXTRAOPTION,SystemPara)
...
IsMete = true;% reanalysis meteorological variables
VARNAME_LIST_Mete =  {'air.sfc','hpbl','shum.2m','vwnd.10m','uwnd.10m'};
DATA_OPTION_LIST_Mete = {'DailyMean','DailyMean','DailyMean','DailyMean','DailyMean'};
...
VARNAME_LIST_OMI = {'OMAERUVd_UVAerosolIndex','OMAEROe_UVAerosolIndex','OMAEROe_VISAerosolIndex',...
    ...
    'GEOSChem_BC','GEOSChem_NH4','GEOSChem_NO2','GEOSChem_OA','GEOSChem_PM25','GEOSChem_SO4'};
% VARNAME_LIST_OMI = {'GEOSChem_BC','GEOSChem_NH4','GEOSChem_NO2','GEOSChem_OA','GEOSChem_PM25','GEOSChem_SO4'};
